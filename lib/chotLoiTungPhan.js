...
const PHAN_CHOT_KET_THUC = { 1: TY_LE_CHOT.tp1, 2: TY_LE_CHOT.tp2, 3: TY_LE_CHOT.tp3 };
...
// ketThucTP3 = true: TP3 ghi 40% (cach moi, lenh ket thuc) thay vi 25% (cach cu).
export function phatHienChotLoiTungPhan({ dsMoi, banGhiCuTheoMa, ngayBan, daGhi = new Set(), ketThucTP3 = false }) {
