...
function chuanHoaHang(row) {
  ...
  // Cach "3 moc KET THUC O TP3" (chi khi AFL bat cong tac KetThucTaiTP3, mac dinh TAT): phien vua khop TP3 (AFL/engine bao BAN voi ly_do_ban = 5) la KET THUC LENH, khong con nam
  // vi the nen hien TRUNG LAP (khong phai BAN). ket_thuc_tp3_moi = true dung cho cot "Ban bot" o trang dau (chi hien trong ngay). Cach 2 TP + giu den BAN (mac dinh): TP3 chi la
  // moc tham khao, lenh van con giu nen KHONG chuyen trang thai.
