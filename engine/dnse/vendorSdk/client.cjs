// COPY NGUYEN VAN tu SDK chinh thuc cua DNSE (github.com/dnse-tech/openapi-sdk, nhanh
// javascript/dnse/client.js, lay ngay 2026-09-22) - GIU NGUYEN. Cac dieu chinh/phong thu rieng
// (vd gui them ca header "X-Aux-Date" vi tai lieu API reference va chinh SDK nay khong khop ten
// header) nam o engine/dnse/openApiClient.js (lop boc ben ngoai), KHONG sua truc tiep o day, de
// de doi chieu lai voi ban goc tren GitHub khi DNSE cap nhat SDK.
'use strict';

const { randomUUID } = require('crypto');
const { buildSignature, formatDateHeader } = require('./common.cjs');
