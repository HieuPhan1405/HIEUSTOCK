...
ok("con lai goc: TP3 = 40 (TP3 chi la moc tham khao, nhu sau TP2)", phanConLaiLenhGoc("TP3") === 40);

// 15% gia 20 + 100 gia 22 => (15*20 + 100*22)/115 = 2500/115 (lenh cu con 15% chay sau TP3)
const tb = giaVonTrungBinh({ conLaiPct: 15, giaMuaGoc: 20, giaMuaMoi: 22 });
ok("gia von TB voi 15% con lai: (15x20+100x22)/115", gan(tb, 2500 / 115), String(tb));
...
ok("diem: con lai goc 40, gia goc 20", d[0].conLaiGocPct === 40 && d[0].giaMuaGoc === 20);
...
ok("da mua dot dau -> MUA THEM, von trung binh", kq.muaThem === true && gan(kq.giaVon, 3000 / 140) && gan(kq.laiLoPct, (24 / (3000 / 140) - 1) * 100) && kq.tinhDuocTrungBinh);
