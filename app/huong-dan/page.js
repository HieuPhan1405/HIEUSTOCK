    ...
    <>
      ...
      <Muc tieuDe="Giải thích ký hiệu">
        ...
        <div className="grid sm:grid-cols-2 gap-x-6">
          ...
          <KyHieu ky="➕" mau="#22D3EE" chu={<><b style={{ color: XANH }}>Mua mới</b> — lệnh vào đợt sau (giá hồi về hỗ trợ rồi bật lên) khi bạn bỏ qua lệnh đầu; là lệnh độc lập, mã có nhiều lệnh được đánh số (1), (2).</>} />
