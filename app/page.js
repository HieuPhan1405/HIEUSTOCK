...
export default async function TrangTongQuan() {
  ...
  return (
    <div style={{ color: "#F5F5F7" }}>
      {/* HERO */}
      <div className="relative overflow-hidden border-b" style={{ borderColor: "#26262F" }}>
        <div className="max-w-5xl mx-auto px-6 pt-14 pb-10">
          <p
            className="text-xs tracking-[0.25em] uppercase mb-3"
            style={{ color: "#6C5CE7", fontFamily: "'JetBrains Mono', monospace" }}
          >
          ...
          <p className="max-w-xl" style={{ color: "#A6A6B3", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        {/* KET LUAN THI TRUONG */}
        <div className="border p-6 mb-10" style={{ borderColor: "#26262F" }}>
        ...
        {/* DO RONG THI TRUONG */}
        <h2 className="text-lg mb-4" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>
          Độ rộng thị trường
        </h2>
        <div className="mb-10">
          {[
            ["Xanh (xu hướng tăng)", soXanh, pctXanh, "#22C55E"],
            ["Sideway", soSideway, pctSideway, "#FBBF24"],
            ["Đỏ (xu hướng giảm)", soDo, pctDo, "#EF4444"],
            ...
            <div key={nhan} className="mb-3">
              ...
              <div className="h-1.5" style={{ background: "#1D1D26" }}>
        ...
        <div className="mb-10">
          {doRongVonHoa.map(([nhan, { tong, xanh, pctXanh }]) => (
            <div key={nhan} className="mb-3">
              ...
              <div className="h-1.5" style={{ background: "#1D1D26" }}>
                <div className="h-full" style={{ width: `${pctXanh}%`, background: "#22C55E" }} />
              </div>
            </div>
          ))}
          <p className="text-[11px] mt-2" style={{ color: "#8B8B99" }}>
        ...
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="text-lg" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>
            Top cơ hội đáng chú ý
          </h2>
          <Link href="/lenh-mo" className="text-xs" style={{ color: "#6C5CE7", fontFamily: "'JetBrains Mono', monospace" }}>
            xem lệnh đang mở →
          </Link>
        </div>

        <div className="grid sm:grid-cols-2 gap-8">
          <CotTinHieu tieuDe="Tín hiệu MUA" mau="#22C55E" danhSach={tinHieuMua} />
          <CotTinHieu tieuDe="Tín hiệu BÁN" mau="#EF4444" danhSach={tinHieuBan} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div>
      <p
        ...
        style={{ color: mau, borderColor: "#26262F", fontFamily: "'JetBrains Mono', monospace" }}
      >
      ...
      {danhSach.map((row) => (
        ...
        >
          <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: "17px" }}>{row.ma}</span>
